          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-white dark:bg-dark_black p-8 rounded-2xl">
              <p className="text-opacity-60">
                ...
                and its respective affiliates (&ldquo;us&rdquo;,
                &ldquo;we&rdquo;, &ldquo;our&rdquo; or
                &ldquo;Getnextjstemplates&rdquo;). This Privacy Statement
                describes our privacy practices in relation to the use of our
                websites (including any customer portal or interactive customer
                website) (
                <Link
                ...
                &ldquo;Services&rdquo;), as well as your choices regarding use,
                access, storage and correction of Personal Information. It also
